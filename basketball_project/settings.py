...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": [
        "basketball.authentication.JWTAuthentication",
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "API para el módulo de Basketball - Gestión de atletas, entrenadores y estudiantes de vinculación",  # noqa: E501
    "VERSION": "1.0.0",
    ...
    "TAGS": [
        {
            "name": "Auth",
            "description": "Autenticación delegada al módulo de usuarios (Bearer token externo)",  # noqa: E501
        },
        {
            "name": "Estudiantes de Vinculación",
            "description": "Gestión de pasantes y estudiantes de vinculación",
        },
    ],
    ...
    "COMPONENTS": {
        "securitySchemes": {
            "BearerAuth": {
                ...
                "scheme": "bearer",
                "bearerFormat": "JWT",
                "description": "Token emitido por el módulo de usuarios (Bearer <token>)",  # noqa: E501
            }
        }
    },
}
...
CORS_ALLOWED_ORIGINS = os.getenv(
    ...
    "http://localhost:3000,http://localhost:5173,http://127.0.0.1:3000,http://127.0.0.1:5173,http://localhost:8096",  # noqa: E501
