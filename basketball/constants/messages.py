...
class ErrorMessages:
    ...
    ENTRENADOR_ESPECIALIDAD_REQUIRED: Final[str] = "especialidad y club_asignado son obligatorios"
    ENTRENADOR_EMAIL_REQUIRED: Final[str] = "Email es obligatorio"
    ENTRENADOR_PASSWORD_REQUIRED: Final[str] = "Password es obligatorio"
    ENTRENADOR_EXTERNAL_NOT_RETURNED: Final[str] = "El módulo de usuarios no retornó external_id"
    ENTRENADOR_EXTERNAL_IN_USE: Final[str] = "El external_id retornado ya está en uso por otro entrenador"
    ...
    NO_PERMISSION_TO_REGISTER: Final[str] = "No tiene permiso para registrar pruebas a este atleta"
    
    # Errores de atleta
    ATLETA_NOT_FOUND: Final[str] = "El atleta no existe"
    ATLETA_NO_ACTIVE_INSCRIPTION: Final[str] = "El atleta no tiene inscripción habilitada"
