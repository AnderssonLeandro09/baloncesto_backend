...
class Atleta(models.Model):
    ...
    edad = models.IntegerField(
        validators=[MinValueValidator(0), MaxValueValidator(100)], verbose_name="Edad"
    )
    ...
    telefono_representante = models.CharField(
        max_length=20, blank=True, null=True, verbose_name="Teléfono representante"
    )
...
class PruebaFisica(models.Model):
    ...
    tipo_prueba = models.CharField(
        max_length=20, choices=TipoPrueba.choices, verbose_name="Tipo de prueba"
    )
