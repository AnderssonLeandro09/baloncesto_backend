...
class AuthControllerTests(SimpleTestCase):
    ...
    def test_login_success(self, mock_post):
        ...
        with patch('basketball.controllers.auth_controller.Administrador.objects.filter') as mock_admin, \
             patch('basketball.controllers.auth_controller.Entrenador.objects.filter') as mock_entrenador, \
             patch('basketball.controllers.auth_controller.EstudianteVinculacion.objects.filter') as mock_estudiante:
